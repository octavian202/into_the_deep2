...
@Autonomous(name = "red stack", group = ".")
public class RedStackAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d spikePos = StackSidePositions.redSpikePos[spikePosition - 1];
        Pose2d backdropPos = StackSidePositions.redBackdropPos[spikePosition - 1];
        ...
        Action driveAction = mecanumDrive.actionBuilder(startPose)
                ...
                .setReversed(false)
                .splineToLinearHeading(StackSidePositions.redParkPos, Math.toRadians(45))
                .build();
